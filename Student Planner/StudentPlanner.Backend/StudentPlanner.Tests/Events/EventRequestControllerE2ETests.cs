...
public class EventRequestControllerE2ETests : IntegrationTestBase
{
    ...
    public async Task ApproveRequest_Create_CreatesAcademicEvent()
    {
        ...
        using var scope = _factory.Services.CreateScope();
        var db = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>();
        var updatedRequest = await db.EventRequests.FindAsync(requestId, TestContext.Current.CancellationToken);
    ...
    public async Task ApproveRequest_Update_UpdatesAcademicEvent()
    {
        ...
        var updatedEvent = await db.AcademicEvents.FindAsync(eventId, TestContext.Current.CancellationToken);
    ...
    public async Task ApproveRequest_Delete_DeletesAcademicEvent()
    {
        ...
        var deletedEvent = await db.AcademicEvents.FindAsync(eventId, TestContext.Current.CancellationToken);
